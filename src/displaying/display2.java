...
public class display2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {  
            ...
            out.println("<tr><th>Name</th><th>email</th><th>Age</th><th>Role</th><th>Recommend</th><th>Rating</th><th>Comments</th><tr>");  
            while (rs.next()) 
            {  
            	count++;
        		...
        		String city=rs.getString("role");
        		String service=rs.getString("recommend");
        		String improve=rs.getString("rating");
